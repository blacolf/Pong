...
class Main:
    def __init__(self):
        ...
        self.ball = Ball(self.canvas, 'white', 25, self.paddle, self.paddle2, self.h, self.w)
        ...
        #Scores add  
        while self.ball.hit_topbottom == False:  
            self.ball.draw()
            self.paddle.draw()
            self.paddle2.draw()
            ...
            if self.ball.hit_top==True:
                score2=score2+1
                self.ball.hit_topbottom == False
                self.ball.hit_top==False
            elif self.ball.hit_bottom==True:
                score=score+1
                self.ball.hit_topbottom == False
